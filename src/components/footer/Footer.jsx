      ...
      <div className="main flex justify-evenly pt-[71px]">
        <div >
          <div className='' >
            ...
            <img src="public/Payment 1.png" alt="" />
          </div>
          <div className='social media pt-[119px] pb-[10px]'>
            ...
            <ul className='flex gap-2 font-Poppins font-medium text-[15px] text-[rgba(0,0,0,0.5)]'>
              <li><Link className="flex items-center pb-1 gap-1 justify-between border-b border-[rgba(0,0,0,0.5)]">Instagram <span><img src="public/arrow-up-right-03.png" alt="" /></span> </Link></li>
              <li><Link className="flex items-center pb-1 gap-1 justify-between border-b border-[rgba(0,0,0,0.5)]">Instagram <span><img src="public/arrow-up-right-03.png" alt="" /></span> </Link></li>
              <li><Link className="flex items-center pb-1  gap-1 justify-between border-b border-[rgba(0,0,0,0.5)]">x <span><img src="public/arrow-up-right-03.png" alt="" /></span> </Link></li>
              
            </ul>
            <ul className='flex pt-[10px] gap-2 font-Poppins font-medium text-[15px] text-[rgba(0,0,0,0.5)]' >
              <li><Link className="flex items-center pb-1 gap-1 justify-between border-b border-[rgba(0,0,0,0.5)]">tiktok <span><img src="public/arrow-up-right-03.png" alt="" /></span> </Link></li>
              <li><Link className="flex items-center pb-1 gap-1 justify-between border-b border-[rgba(0,0,0,0.5)]">Linkedin <span><img src="public/arrow-up-right-03.png" alt="" /></span> </Link></li>
              <li><Link className="flex items-center pb-1 gap-1 justify-between border-b border-[rgba(0,0,0,0.5)]">Youtube <span><img src="public/arrow-up-right-03.png" alt="" /></span> </Link></li>
            </ul>
        ...
        <div >
          <div className=' flex flex-col ml-[340px]'>
            ...
            <div className='w-fit flex items-center  border-2 p-[9px] border-black rounded-[30px] mb-[126px]'>
              ...
              <button className='flex items-center gap-[20px] px-[14px]  py-[10px]  text-[15px] font-Poppins bg-black text-white rounded-[30px]'>submit <span><img src="public/arrow-right.png" alt="" className='w-[24px] h-[24px]' /></span></button>
            </div>
          ...
          <div className='flex gap-[199px] pb-[84px]' >
            <div>
              ...
              <ul className='font-Poppins flex gap-[20px] items-center font-medium p-0 text-[rgba(0,0,0,0.5)] text-[15px] '>
                ...
                <img src="public/Line 16.png" alt="" />
              </ul>
            </div>
           <div>
