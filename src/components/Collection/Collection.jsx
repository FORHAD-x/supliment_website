...
const Collection = () => {
  return (
    ...
    <section className='Collection container px-[105px] pb-[90px]'>
        ...
        <div className='flex justify-between'>
            ...
            <div className="product w-[322px] h-[360px] bg-[#F6F6F6] rounded-[8px]">
                ...
                <div className='w-[294px] flex justify-between  items-center bg-[#FFFFFF] mx-auto mt-[22px] rounded-[2px]'>
                    ...
                    <div className='bg-black w-[38px] h-[36px] m-1 rounded-[4px] flex items-center justify-center'><img src="public/shopping-cart-01.png" alt="" /></div>
                </div>
            </div>
        ...
        <button className='w-[73px] h-[34px] mt-1 bg-black flex items-center justify-center rounded-[17px]'><img src="public/arrow-right.png" alt="" /></button>
